...
namespace BugTracker.Persistence.Migrations
{
    ...
    [Migration("20241118095708_AddDescriptionColumn")]
            ...
            modelBuilder.Entity("BugTracker.Domain.IssuePriority", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3776),
                            DateModified = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3848),
                            Name = "Low"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3857),
                            DateModified = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3862),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3870),
                            DateModified = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3876),
                            Name = "High"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3885),
                            DateModified = new DateTime(2024, 11, 18, 10, 57, 7, 621, DateTimeKind.Local).AddTicks(3891),
                            Name = "Critical"
                        });
                });
