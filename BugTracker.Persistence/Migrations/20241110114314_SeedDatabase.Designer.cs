...
namespace BugTracker.Persistence.Migrations
{
    ...
    [Migration("20241110114314_SeedDatabase")]
            ...
            modelBuilder.Entity("BugTracker.Domain.IssuePriority", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9275),
                            DateModified = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9325),
                            Name = "Low"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9331),
                            DateModified = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9333),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9336),
                            DateModified = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9338),
                            Name = "High"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9340),
                            DateModified = new DateTime(2024, 11, 10, 12, 43, 13, 613, DateTimeKind.Local).AddTicks(9342),
                            Name = "Critical"
                        });
                });
